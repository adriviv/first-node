...
function typeAhead(search) {
    ...
    searchInput.on('input', function () {
        ...
        _axios2.default.get('/api/search?q=' + this.value).then(function (res) {
            ...
            searchResults.innerHTML = '<div class="search__result">No result for ' + _this.value + ' found!</div>';
        }).catch(function (err) {
            console.error(err);
        });
    });
    ...
    searchInput.on('keyup', function (e) {
        ...
        var activeClass = 'search__result--active'; // where we are currently on 
        var current = search.querySelector('.' + activeClass); // if someone press up or down 
        var items = search.querySelectorAll('.search__result'); // on va chercher dans la list de  all the search 
        var next = void 0; // which one is is gonna be the next one 
...
var heartForms = (0, _bling.$$)('form.heart'); // $$ means document.querySelectorAll
